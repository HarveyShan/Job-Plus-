...
@JsonIgnoreProperties(ignoreUnknown = true) //try without these two
@JsonInclude(JsonInclude.Include.NON_NULL) //1 not as important
...
public class Item {
    ...
    private Set<String> keywords; //1
    private boolean favorite; //1
    ...
    @JsonProperty("company_logo") //try comment out
